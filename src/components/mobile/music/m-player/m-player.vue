<template>
  <div class="tbe-m-music-m-player" v-show="playList.length">
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="player-middle" @click="changeMiddle">
          ...
          <transition name="middleR">
            <scroll class="middle-behind" ref="lyricList" :data="currentLyric && currentLyric.lines"
                    v-show="currentShow === 'lyric'">
              <div class="lyric-wrapper">
                <div class="currentLyric" v-if="currentLyric">
                  <p ref="lyricLine" class="text" :class="{'highLight':currentLineNum === index}"
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="onProgressBarChange"
                            @percentChangeEnd="onPercentChangeEnd"></progress-bar>
            </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control">
          <i class="iconfont icon-hamburg" @click.stop="showPlayList"></i>
        </div>
      </div>
    </transition>
    <play-list ref="playlist"></play-list>
    <audio id="music-audio" ref="audio" @canplay="ready" @error="error" @timeupdate="updataTime" @ended="end"
           autoplay></audio>
  </div>
</template>
...
<script>
  ...
  import PlayList from 'mobile/music/playlist/playlist'
